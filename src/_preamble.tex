...
% 132 + 3mm bleed = 135mm
% 197 + 3mm bleed = 200mm
% \usepackage[width=135mm,height=200mm,cross,center,noinfo]{crop} % bleed
...
% redfine table of contents with text-center and shorter top-bottom margins
\makeatletter
...
\begin{center}
{
    ...
    \vspace{1em}
    First Printing. 50 copies. £282.50.\\
    \vspace{1em}
